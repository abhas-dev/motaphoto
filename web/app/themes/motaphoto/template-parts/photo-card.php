...
<div class='card-photo'>
    ...
    <div class='overlay-photo'>
        <div class="card-photo__description">
            ...
            <a class="icon-eye" href="<?= esc_url(get_permalink()); ?>">
                <svg mlns="http://www.w3.org/2000/svg" width="46" height="32" viewBox="0 0 46 32" fill="none">
            ...
            <p class="card-photo-category"><?= get_the_terms(get_post(), 'photo_category')[0]->name ?></p>
        </div>
    </div>
</div>
